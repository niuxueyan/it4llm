...
(function() {
    var talks = {
        ...
        rowan: {
            speaker: 'Joseph Rowan (University of Toronto), Ashish J. Khisti (University of Toronto)',
        ...
        zheng: {
            speaker: 'Ce Zheng (Pengcheng Lab), Xinghan Wang (Pengcheng Lab), Jiahong Ning (Dalian Maritime University), Yuxuan Shi (Pengcheng Lab), Ning Huang (Pengcheng Lab), Tingting Yang (Pengcheng Lab)',
